...
function Projects() {
  ...
  return (
    <div className='absolute top-0 left-[20%]'>
        ...
        active:scale-[.85]'><LiaTimesSolid onClick={() => dispatch(closeProjectModal)} /></div>
        <div open={Open} onClose={() => dispatch(closeProjectModal())} className='flex justify-center items-center'>
            <Modal className='shadow-2xl bg-white w-[350px] h-[600px] rounded-l-2xl'>
            ...
            <Modal className='shadow-2xl bg-[#f4eedb] w-[500px] h-[600px] rounded-r-2xl overflow-auto'>
                <div className='px-[40px] py-[76px]'>
