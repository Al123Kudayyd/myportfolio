...
function Projects({ btn }) {
  return (
    <div className='absolute top-0 left-[20%]'>
        <div className='text-gray-400 absolute right-10 top-8 cursor-pointer text-3xl hover:text-text-gray transition-all duration-300
        active:scale-[.85]'>{btn}</div>
