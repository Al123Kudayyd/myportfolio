...
function Main() {
  ...
  return (
    ...
    {
        openModal && <Model btn={<LiaTimesSolid onClick={() => setOpenModal(false)} />} btn2={<LiaBarsSolid onClick={() => setOpenModal(true)} />} /> 
    }
    <div className='absolute top-[10%] right-0 text-2xl space-y-5 m-3'>
        ...
        <Projects btn={<LiaTimesSolid onClick={() => setOpenProjectModel(false)} />} />
    </div>
  )
}
