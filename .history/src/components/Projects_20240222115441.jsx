...
function Projects({ button }) {
  ...
  return (
    <div className='absolute top-0 left-[20%] mt-10 skew-y-12 -skew-y-12'>
        ...
        <div className='flex justify-center items-center'>
            <div className='shadow-2xl bg-white w-[350px] h-[600px] rounded-l-2xl animate-fade'>
            ...
            <div className='shadow-2xl bg-[#f4eedb] w-[500px] h-[600px] rounded-r-2xl overflow-auto animate-fades'>
                <div className='px-[40px] py-[76px]'>
