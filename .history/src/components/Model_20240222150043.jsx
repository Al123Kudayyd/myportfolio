...
function Model({ btn }) {
  ...
  return (
    <div className='flex justify-center items-end relative'>
        <div className='shadow-2xl w-[750px] h-[500px] absolute bottom-72 rounded-[20px] z-40 bg-black overflow-hidden max-w-[1100px]'>
        ...
        active:scale-[.85]'>{btn}
          ...
          <div className='flex flex-col items-center'>
            <form className='flex flex-col items-center text-xl mt-20 w-screen'>
