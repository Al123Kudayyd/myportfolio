...
function Main() {
  ...
  return (
    ...
    {
        openModal && <Model openModal={openModal} setOpenModal={setOpenModal()} btn={<LiaTimesSolid onClick={() => setOpenModal(false)} />} /> 
    }
    <div className='absolute top-1/4 right-0 text-2xl space-y-5 m-3'>
            <FaHtml5 />
            <FaCss3Alt />
            <IoLogoJavascript />
            <FaReact />
