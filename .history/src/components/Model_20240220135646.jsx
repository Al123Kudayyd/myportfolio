...
function Model({ btn }) {
  ...
  return (
    <div className='flex justify-center items-end -mt-80 relative max-w-[1400px]'>
        <div className='shadow-2xl w-[750px] h-[500px] absolute rounded-xl z-40 bg-black animate-pulse overflow-hidden'>
