...
function Model({ btn }) {
  ...
  return (
    <div className='flex justify-center items-end relative mx-14'>
        <div className='shadow-2xl h-[500px] max-w-[400px]  absolute bottom-72 rounded-[20px] z-40 bg-black overflow-hidden md:max-w-[800px]'>
        ...
        active:scale-[.85]'>{btn}
          ...
          <div className='flex flex-col items-center'>
            <form className='flex flex-col items-center text-xl mt-20 px-10 '>
              ...
              <label className='flex flex-col justify-center w-11/12 text-gray-400'>Message
                <textarea 
                className='border-b-4 bg-black text-sm  border-gray-400 outline-none mb-6 transition-all duration-300 focus:border-[#f4eedb]' 
                type={'message'}  />
              </label>
