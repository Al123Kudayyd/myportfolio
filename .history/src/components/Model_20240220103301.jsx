          ...
          <div className='flex flex-col items-center'>
            <form className='flex flex-col items-center bg-[#f4eedb] text-xl mt-20 w-80'>
              <label className='flex flex-col justify-center text-black'>Name
                <input className='bg-[#f4eedb] border-b-4  border-gray-400 outline-none mb-6 focus:text-[]' type={'text'} />
              </label>
              <label className='flex flex-col justify-center text-black'>Email
                <input className='bg-[#f4eedb] border-b-4  border-gray-400 outline-none mb-6 focus:text-[]' type={'email'}  />
              </label>
              <label className='flex flex-col justify-center text-black'>Message
                <input className='bg-[#f4eedb] border-b-4  border-gray-400 outline-none mb-6 focus:text-[]' type={'message'}  />
              </label>
