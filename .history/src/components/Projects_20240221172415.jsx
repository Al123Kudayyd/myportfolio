...
function Projects() {
  ...
  return (
    <div className='absolute top-0 left-[20%]'>
        ...
        <div className='flex justify-center items-center' onClose={() => dispatch(closeProjectModal())}>
            <div open={Open}  className='shadow-2xl bg-white w-[350px] h-[600px] rounded-l-2xl'>
