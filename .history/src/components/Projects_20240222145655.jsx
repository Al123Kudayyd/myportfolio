...
function Projects({ button }) {
  ...
  return (
    <div className='absolute top-0 left-[50%] mt-20 animate-fade '>
        <div className='text-gray-400 absolute right-1/2 top-8 cursor-pointer text-3xl hover:text-black transition-all duration-300
        active:scale-[.85]'>{button}</div>
        <div className='flex justify-center items-center w-screen'>
            <div className='shadow-2xl bg-white w-[350px] h-[600px] rounded-l-2xl overflow auto'>
