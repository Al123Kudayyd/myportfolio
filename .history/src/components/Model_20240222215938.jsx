...
function Model({ btn }) {
  ...
  return (
    <div className='flex justify-center items-end relative mx-14'>
        <div className='shadow-2xl h-[500px] max-w-[400px] w-1.2 w-screen absolute bottom-72 rounded-[20px] z-40 bg-black overflow-hidden md:max-w-[800px]'>
          ...
          <div className='flex flex-col items-center'>
            <form className='flex flex-col items-center text-xl mt-20 px-10 '>
              ...
              <div className='flex justify-center items-center'>
                <label className='flex flex-col justify-center w-2/5 text-gray-400'>Name
                  <input 
                  className='border-b-4 bg-black text-sm  border-gray-400 outline-none mb-6 transition-all duration-300 focus:border-[#f4eedb]' 
                  type={'text'} />
                </label>
                <label className='flex flex-col justify-center w-2/5 ml-5 text-md text-gray-400'>Email
                  <input 
                  className='border-b-4 bg-black text-sm  border-gray-400 outline-none mb-6 transition-all duration-300 focus:border-[#f4eedb]' 
                  type={'email'}  />
                </label>
