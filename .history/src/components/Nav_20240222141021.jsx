...
function Nav({ button, button1 }) {
  ...
  return (
    <div className='bg-[#f4eedb] '>
        {
            modal ? <Modal /> : <div className='flex justify-between items-center'>
            <img src={logo} className="w-[20%] md:w-1/12 " />
            <LiaBarsSolid onClick={() => setModal()} className='sm:hidden text-3xl mr-5 hover:text-gray-400 cursor-pointer active:scale-[.85] transition-all duration-300' />
