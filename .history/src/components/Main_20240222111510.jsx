...
function Main() {
  ...
  return (
    ...
    <div className='absolute top-[10%] right-0 text-2xl  m-3'>
        <a href="" className='' ><FaFacebook className='cursor-pointer' /></a>
        <a href="https://uk.linkedin.com/in/sammy-al-khudayyd-17656b246" className=''><FaLinkedin className='cursor-pointer my-5' /></a>
